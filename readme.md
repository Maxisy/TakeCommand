A plugin for Minecraft that allows you to use /take command, which takes a specified amound of specified item from specified player's inventory. Written in Java 14
